    ...
    <el-card shadow="never">
      ...
      <el-form ref="formRef" :model="form" :rules="rules" label-width="150px">
        <el-row :gutter="24">
          ...
          <el-col :span="12">
            <el-form-item label="Giá trị khớp" prop="matchedValue">
              <el-input-number v-model="form.matchedValue" :min="0" style="width:100%" />
            </el-form-item>
          </el-col>
...
const form = ref({
  ...
  volume: 0, orderPrice: 0, matchedVolume: 0, matchedValue: 0,
...
const rules = {
  ...
  matchedValue: [{ required: true, type: 'number', min: 1, message: 'Giá trị khớp > 0' }]
}
...
async function submit() {
  ...
  try {
    if (isEdit.value) {
      await store.updateTransaction(route.params.id, form.value)
